...
public class Split
	 ...
	 *
	 * @param from             (ignored)
	 * @param executionContext the current {@link ExecutionContext execution context}.
	 */
	 ...
	 *
	 * @param transition       (ignored in the case of a {@link Split})
	 * @param executionContext the current {@link ExecutionContext execution context}
	 * @throws CheckNotMetException if not all of the {@link Check Conditions} attached to
	 ...
	 *
	 * @param executionContext the current (parent) {@link ExecutionContext execution
	 *                         context}.
	 * @param newTransition    the new (split) {@link Transition}.
	 * @param parent           the {@link Token parent Token}.
	 */

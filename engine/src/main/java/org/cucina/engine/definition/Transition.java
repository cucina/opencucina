...
public class Transition
	 ...
	 * {@link Transition} being ended.
	 *
	 * @param actions the {@link Operation Actions} that are fired just prior to this
	 *                {@link Transition} being ended.
	 */
	 ...
	 *
	 * @param conditions the {@link Check Conditions} to test before transitioning
	 ...
	 *
	 * @throws IllegalStateException if the {@link #getInput() input place} has not yet been set
	 ...
	 *
	 * @param action the {@link Operation} to be so added.
	 */

...
public interface BulkWorkflowService {
     ...
     *            applicationType of objects.
     * @param workflowId
     *            String workflowId of items to be transitioned.
     * @param transitionId
     *            String id of the transition to run.
     * @param parameters
     *            Map<String, Object> to be passed to workflow session.
     */
     ...
     *
     * @param ids
     *            IDs of objects to be transitioned.
     * @param applicationType
     *            applicationType of objects.
     * @param workflowId
     *            String workflowId of items to be transitioned.

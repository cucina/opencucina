 ...
 * @version $Revision: $
 */
public class ParameterValueExtractorOperationDefinitionParser
		extends AbstractDefaultIdBeanDefinitionParser {
	public static final String DEFAULT_ID = "parameterValueExtractorOperation";
	...
	protected Class<?> getBeanClass(Element element) {
		return ParameterValueExtractorOperation.class;
	}

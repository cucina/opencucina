...
public class SearchBeanFactoryImpl
	 ...
	 * JAVADOC Method Level Comments
	 *
	 * @param criteriaOverrides JAVADOC.
	 */
	 ...
	 * JAVADOC Method Level Comments
	 *
	 * @param defaultProjectionGroup JAVADOC.
	 */
	 ...
	 *
	 * @param projectionFactory ProjectionFactory
	 */
	@Required
	 ...
	 * JAVADOC Method Level Comments
	 *
	 * @param projectionProviders JAVADOC.
	 */
	 ...
	 * JAVADOC Method Level Comments
	 *
	 * @param subjectType JAVADOC.
	 * @param search      JAVADOC.
	 * @param alias       String, if not provided will depend upon CountProjection
	 *                    assigning.
	 */
	@Override

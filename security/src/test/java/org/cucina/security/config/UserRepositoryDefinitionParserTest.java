 ...
 * @version $Revision: $
 */
public class UserRepositoryDefinitionParserTest {
    private UserRepositoryDefinitionParser parser = new UserRepositoryDefinitionParser();
    ...
    public void testGetBeanClassElement() {
        assertEquals(UserRepositoryImpl.class, parser.getBeanClass(null));
    }
    ...
    public void testResolveId() {
        ...
        assertEquals(UserRepositoryDefinitionParser.DEFAULT_ID, parser.resolveId(element, null, parserContext));

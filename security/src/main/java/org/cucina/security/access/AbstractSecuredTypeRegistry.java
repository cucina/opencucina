            ...
            try {
                ...
                for (int i = 0; i < descriptors.length; i++) {
                    ...
                    if (descriptors[i].getWriteMethod() != null) {
                        ...
                        if ((CollectionUtils.isEmpty(securableTypes) || securableTypes.contains(propertyType)) && instanceFactory.isForeignKey(type, propertyName)) {
                            persistableProperties.add(NameUtils.concat(propertyName, propertyType));
                        }
                    }
                }

...
public class UploadDimensionsEditor
    ...
    /**
     * Creates a new UploadDimensionsEditor object.
     *
     * @param instanceFactory JAVADOC.
     */
    public UploadDimensionsEditor(InstanceFactory instanceFactory) {
        super();
    ...
    public void setAsText(String text)
        ...
        for (String token : tokens) {
            ...
            if (props.length == 2) {
                Dimension dim = instanceFactory.<Dimension>getBean(Dimension.class.getSimpleName());

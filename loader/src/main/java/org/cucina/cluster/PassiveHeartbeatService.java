...
public class PassiveHeartbeatService
	 ...
	 *
	 * @param scheduleService the schedule service to use.
	 * @param interval        How often to publish the event in seconds
	 *                        {@link ScheduleServiceImpl}.
	 * @param event           The instance of an event to publish at each scheduled moment.
	 */
